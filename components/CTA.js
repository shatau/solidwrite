...
const CTA = () => {
  return (
    <section className="relative bg-gradient-to-br from-orange-700 via-orange-600 to-orange-800 py-20 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <button
            ...
            className="group px-8 py-4 bg-white text-orange-700 rounded-xl font-bold text-lg shadow-2xl hover:shadow-3xl transition-all hover:scale-105 flex items-center gap-2"
          >
            Get Started Free
